        ...
        <li>
          ...
          <ul id="bs1" class="collapse">
            ...
            <select>
              ...
              <option value="giving.php" class=""><i class="icon-chevron-right"></i><i class="icon-money"></i> Offering</option>
              <option value="giving.php" class=""><i class="icon-chevron-right"></i><i class="icon-money"></i> Tithes</option>
              <option value="giving.php" class=""><i class="icon-chevron-right"></i><i class="icon-money"></i> Other Giving</option>
