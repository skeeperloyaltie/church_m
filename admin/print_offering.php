...
font-family:"Times New Roman","serif"'><img width=100 height=20 id="Picture 1" src="images/logo.png"></span></b></p>
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['paytime']; ?><o:p></o:p></span></p>
                      ...
                      <?php
$totalAmount = 0; // Initialize total offering amount
$student_query = mysqli_query($conn, "SELECT * FROM members INNER JOIN offering ON members.mobile = offering.na") or die(mysqli_error($conn));
while ($row = mysqli_fetch_array($student_query)) {
    $totalAmount += $row['Amount']; // Add the current row's amount to total
    ?>
    <tr style='mso-yfti-irow:1'>
        <!-- Row Data Here -->
    </tr>
...
<tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes'>
    <td colspan="5" align="right" style='padding:0in 5.4pt 0in 5.4pt;background:#D9D9D9;'><b>Total Offering:</b></td>
    <td style='padding:0in 5.4pt 0in 5.4pt;'><b><?php echo number_format($totalAmount, 2); ?></b></td>
</tr>
...
"Times New Roman","serif"'>
 ...
 0in 5.4pt 0in 5.4pt;mso-border-insideh:none;mso-border-insidev:none'>
  ...
  height:17.85pt'>
                          <p class=msoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><u><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'><?php echo $row['firstname'] . " " . $row['lastname'];  ?><o:p></o:p></span></u></b></p>
                        </td>
                        <td width=376 valign=top style='width:281.85pt;padding:0in 5.4pt 0in 5.4pt;
  height:17.85pt'>
                          <p class=msoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
